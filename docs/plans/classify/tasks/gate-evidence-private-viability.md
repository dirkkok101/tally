...
| [TASK-INGEST-GATE-MODULE: Complete the INGEST v1 module gate](../../ingest/tasks/gate-module.md) | `task` | `blocked-by` | `true` |
...
- `blocked-by` -> [TASK-INGEST-GATE-MODULE: Complete the INGEST v1 module gate](../../ingest/tasks/gate-module.md)
