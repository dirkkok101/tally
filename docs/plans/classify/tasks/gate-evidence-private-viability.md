...
Representative owner evidence proves recurrence, material decision reduction, zero incorrect batch-apply canaries, a documented temporal hold-out procedure, and local-only execution or CLASSIFY stops.
...
- Aggregate private-evidence report containing counts, SHA-256 fingerprints, threshold outcomes, environment identity, timestamp, and no private payload
