...
| [TASK-INGEST-LEDGER-EVIDENCE-CONTRACT-CORRECTION](tasks/ledger-evidence-contract-correction.md) | Align frozen Ledger evidence with the released contract | `ready` | 0 | SP-INGEST-00-FOUNDATION: Public prerequisites and local foundations |
| [TASK-INGEST-STATUS-STATE-V002](tasks/status-state-v002.md) | Add durable errors and status snapshot schema | `ready` | 0 | SP-INGEST-00-FOUNDATION: Public prerequisites and local foundations |
...
| [TASK-INGEST-LEDGER-PUBLIC-CLIENT](tasks/ledger-public-client.md) | [TASK-INGEST-LEDGER-EVIDENCE-CONTRACT-CORRECTION](tasks/ledger-evidence-contract-correction.md) | `compile` | The client consumes the corrected exact public frozen RecordTransactionInput without translation. |
