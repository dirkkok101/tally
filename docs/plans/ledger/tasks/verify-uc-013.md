...
|---|---|---|---|
| [FR-LEDGER-EVIDENCE-REGISTRATION: Register and link generic evidence](../../../prd/ledger/prd.md#fr-ledger-evidence-registration-register-and-link-generic-evidence) | `requirement` | `verifies` | `true` |
| TC-LEDGER-EVIDENCE-REGISTRATION-CONTRACT: Verify generic evidence registration and linkage | `test_case` | `verifies` | `true` |
| [UC-LEDGER-013: Register and link additional transaction evidence](../../../prd/ledger/prd.md#uc-ledger-013-register-and-link-additional-transaction-evidence) | `use_case` | `covers` | `true` |
...
| VerifiedUC013 | `produces` | [UC-LEDGER-013](../../../prd/ledger/prd.md#uc-ledger-013-register-and-link-additional-transaction-evidence) |  |
...
- `covers` -> [UC-LEDGER-013: Register and link additional transaction evidence](../../../prd/ledger/prd.md#uc-ledger-013-register-and-link-additional-transaction-evidence)
...
- `verifies` -> [FR-LEDGER-EVIDENCE-REGISTRATION: Register and link generic evidence](../../../prd/ledger/prd.md#fr-ledger-evidence-registration-register-and-link-generic-evidence)
