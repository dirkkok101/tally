...
public sealed class CliContractTests
{
    ...
    [Fact] public void Registry_contains_exactly_72_provider_neutral_operations() => Assert.Equal(72, OperationRegistry.Create().Descriptors.Count);
    // TC-LEDGER-CONTRACT-DISCOVERY-CONTRACT
    [Fact]
    public void Schema_list_has_a_stable_independent_contract_inventory()
    {
        ...
        Assert.Equal(72, operationIds.Distinct(StringComparer.Ordinal).Count());
